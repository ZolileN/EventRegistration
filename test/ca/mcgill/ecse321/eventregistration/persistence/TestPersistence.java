...
public class TestPersistence {
	...
	public void setUp() throws Exception {
		...
		//create participants
		Participant pa = new Participant("Kevin");
		Participant pa2 = new Participant("Rami");
	...
	public void test() {
		...
		assertEquals("Kevin", rm.getParticipant(0).getName());
		assertEquals("Rami", rm.getParticipant(1).getName());
		...
		//check registration
		assertEquals(rm.getRegistrations().size(), 2);
